...
parser.add_argument('--prefix', dest='prefix', default='RUNIDa.pm',
                    help = 'Filename prefix (before year)')
parser.add_argument('--suffix', dest='suffix', default='%b.nc',
                    help = 'Filename suffix in strftime format (part after year)')
...
def get_year(filename):
    reg = re.compile('%s(\d{4,4})' % args.prefix)
